...
map.getView().fit([503873.392471, 6559010.118928, 503974.621003, 6559118.347296], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">25182_Masquelier</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (85 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Cliquer sur la position d\'un arbre pour avoir sa description et un lien vers sa photo';
            }
